...
* Only the English page is authored by hand. Everything else (the zh-TW stub,
  both chapter lists) is derived from it.
...
* The translation hash covers the page BODY only, so changing `part:` or
  `order:` never marks a reviewed translation as outdated.
...
FM_ORDER = ["part", "order", "translation-of", "reviewed"]
...
def write(p: Path, text: str) -> bool:
